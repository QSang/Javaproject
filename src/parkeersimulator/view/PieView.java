...
public class PieView extends AbstractView {
    ...
    protected void paintComponent(Graphics a) {
        ...
        aantalEmpty = 540 - aantalPassCar - aantalAdHoc - aantalReserveringsCars;
        ...
        a.fillArc(15, 15, 250, 250, calculateDegrees(aantalAdHoc) + calculateDegrees(aantalPassCar) , calculateDegrees(aantalReserveringsCars));
